...
const InvitationCard = ({
  ...
  const fetchInvitees = (page) => {
    ...
    API.get(`/api/user/aff/invitees?page=${page}&page_size=${PAGE_SIZE}`)
      .then((res) => {
        if (res.data.success) {
  ...
  const fetchCommissions = (page) => {
    ...
    API.get(`/api/user/aff/commissions?page=${page}&page_size=${PAGE_SIZE}`)
      .then((res) => {
        if (res.data.success) {
              ...
              <Spin spinning={inviteesLoading}>
                <Table
                  ...
                  pagination={{
                    ...
                    total: inviteesTotal,
                    showTotal: true,
                    onPageChange: (page) => setInviteesPage(page),
                  }}
