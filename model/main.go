...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&InvoiceRecord{},
		&InvoiceRecordApplication{},
		&SubscriptionConversionBatch{},
		&SubscriptionConversionItem{},
		&CustomOAuthProvider{},
		&UserOAuthBinding{},
		&ReferralCommission{},
	)
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&InvoiceRecordApplication{}, "InvoiceRecordApplication"},
		{&SubscriptionConversionBatch{}, "SubscriptionConversionBatch"},
		{&SubscriptionConversionItem{}, "SubscriptionConversionItem"},
